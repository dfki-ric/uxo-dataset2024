# Adapted from https://stackoverflow.com/a/47342469/2061551
...
class QRangeSlider(QtWidgets.QWidget, Ui_Form):
    ...
    def _valueToPos(self, value):
        return scale(value, (self.min(), self.max()), (0, self.width() - 4))

    def _posToValue(self, xpos):
        return scale(xpos, (0, self.width() - 4), (self.min(), self.max()))
